...
export default function Formulario() {
  ...
  const handleSubmit = () => {
    ...
    const requiredFields = [
      ...
      'pesoMedioReprodutorInput', 'descarteInput', 'crescimentoInput',
      'precoKgInput', 'anosSimuladosInput', 'FmateriaSecaInput', 'MmateriaSecaInput', 'BmateriaSecaInput', 'BA1materiaSecaInput', 'BA2materiaSecaInput',
      'FdiasSuplementosInput', 'MdiasSuplementosInput', 'BdiasSuplementosInput', 'BA1diasSuplementosInput', 'BA2diasSuplementosInput',
      'FvolumosoInput', 'MvolumosoInput', 'BvolumosoInput', 'BA1volumosoInput', 'BA2volumosoInput',
      'FmateriaSeca_volumosoInput', 'MmateriaSeca_volumosoInput', 'BmateriaSeca_volumosoInput', 'BA1materiaSeca_volumosoInput', 'BA2materiaSeca_volumosoInput',
      'FmateriaSeca_concentradoInput', 'MmateriaSeca_concentradoInput', 'BmateriaSeca_concentradoInput', 'BA1materiaSeca_concentradoInput', 'BA2materiaSeca_concentradoInput'
    ];
  ...
  return (
    <ScrollView style={styles.container}
      ...
      <View style={styles.formBox} >
        ...
        <View>
          <Text style={styles.label}>% Mortalidade de até um ano</Text>
        ...
        <View >
          <Text style={styles.label}>Peso médio ao desmame</Text>
        ...
        <View >
          <Text style={styles.label}>Peso médio ao abate</Text>
        ...
        <View >
          <Text style={styles.label}>Peso médio da matriz</Text>
        ...
        <View >
          <Text style={styles.label}>Peso médio do reprodutor</Text>
        ...
        <View >
          <Text style={styles.label}>Preço por Kg de animal</Text>
        ...
        <View >
          <Text style={styles.label}>Consumo de matéria seca das matrizes (% do peso vivo)</Text>
        ...
        <View >
          <Text style={styles.label}>Consumo de matéria seca dos reprodutores (% do peso vivo)</Text>
        ...
        <View >
          <Text style={styles.label}>Número de dias em que as matrizes serão suplementadas</Text>
        ...
        <View >
          <Text style={styles.label}>Números de dias em que os reprodutores serão suplementados:</Text>
        ...
        <View >
          <Text style={styles.label}>% de volumoso na dieta das matrizes</Text>
        ...
        <View >
          <Text style={styles.label}>% de volumoso na dieta dos reprodutores</Text>
        ...
        <View >
          <Text style={styles.label}>% de matéria seca do volumoso na dieta das matrizes</Text>
        ...
        <View >
          <Text style={styles.label}>% de matéria seca do volumoso na dieta dos reprodutores</Text>
        ...
        <View >
          <Text style={styles.label}>% de matéria seca do concentrado na dieta das matrizes</Text>
        ...
        <View >
          <Text style={styles.label}>% de matéria seca do concentrado na dieta dos reprodutores</Text>
